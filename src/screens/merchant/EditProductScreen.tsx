...
import { MerchantProductStackParamList } from '../../types';
import { useProducts } from '../../store/products';
import * as ImagePicker from 'expo-image-picker';
import { Ionicons } from '@expo/vector-icons';
import { PRODUCT_CATEGORIES, ProductCategoryId } from '../../constants/categories';

type Props = NativeStackScreenProps<MerchantProductStackParamList, 'EditProduct'>;
    ...
    if (!product) {
        return (
            <View style={styles.centered}>
                <Text style={styles.errorText}>ไม่พบสินค้า</Text>
